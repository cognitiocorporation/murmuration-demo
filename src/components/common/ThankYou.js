...
import ThankYouImage from "../../images/idea_done.png"
                            ...
                            <Row>
                                {/* <Col lg="12" style={{backgroundColor: 'white'}}>  */}
                                    ...
                                    <div className="mx-auto mb-4 mt-4">
                                        <div>
                                            <img src={ThankYouImage} className="mx-auto d-block" style={{minWidth: 300, maxWidth:300}}/>
                                        </div>
                                    </div>
                            </Row>
                            {/* <span> */}
                            <Row>
                                <h5 className="mx-auto" style={{color: titleColor1, fontWeight: 400, color: '#303030', marginRight: 10}}>Thank you for <em>your</em> contribution !</h5>
                            </Row>
