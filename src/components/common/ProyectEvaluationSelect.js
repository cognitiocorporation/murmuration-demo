...
class ProyectEvaluationSelect extends React.Component {
    ...
    changeSelectedValue(selectionValue) {
        if (selectionValue === 1) {
            ...
            this.props.setCategory('Ejecutar Proyecto');
    ...
    render() {
        ...
        <span><h6 className="text-center" style={{color: titleColor2}}>{t("NEEDS_INFO_PROJECT")}</h6></span>
                        </div>
                    </div>
                    <div className="col my-auto" >
                        <div className="square"  onClick={(event) => { this.changeSelectedValue(3)}}>
                            ...
                            <span><h6 className="text-center" style={{color: titleColor3}}>{t("HOLD_PROJECT")}</h6></span>
                        </div>
                    </div>
                    <div className="col my-auto" >
                        <div className="square"  onClick={(event) => { this.changeSelectedValue(5)}}>
                            ...
                            <span><h6 className="text-center" style={{color: titleColor5}}>{t("NOT_PURSUED_PROJECT")}</h6></span>
                        </div>
                    </div>
                    <div className="col my-auto" >
                        <div className="square"  onClick={(event) => { this.changeSelectedValue(1)}}>
                            ...
                            <span><h6 className="text-center" style={{color: titleColor1}}>{t("JUST_DO_PROJECT")}</h6></span>
                        </div>
                    </div>
                    {/* <div className="col my-auto" hidden={!showAction}>
...
export default withTranslation()(ProyectEvaluationSelect);