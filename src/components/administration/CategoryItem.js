    ...
    <Row>
      ...
      <Col lg="10" className="m-auto">
              ...
              <div style={{backgroundColor: '#F6F6F6',}}>
               <EditCategoryForm refreshIdea={updateCategories} categoryData={category} canSubmit={canSubmit} setFinishedSaving={() => setFinished()} ideaStage={ideaStage} changeStatus={(status) => changeBtnStatus(status)} changeContinueStatus={(status) => changeContinueBtnStatus(status)} changeIdeaStage={() => this.changeIdeaStage()}/>
              </div>
              }
      </Col>
    </Row>
