...
export default function () {
  ...
  return [{
    ...
    },
    {
      ...
      to: '/entradas-verificacion',
      roles:['verification','super_user'],
    ...
    {
      title: t("MENU_RECOGNITION"),
      to: '/ecommerce',
      roles:['recognition','super_user'],
      htmlBefore: '<i class="material-icons">verified_user</i>',
      htmlAfter: '',
      items: [{
        title: t("MENU_INCOMING_RECOGNITION"),
        to: '/entradas-reconocimiento',
        roles:[ 'recognition','super_user'],
        htmlBefore: '<i class="material-icons">record_voice_over</i>',
        htmlAfter: '',
      },{
      title: t("MENU_HISTORY"),
      to: '/historial-reconocimiento',
      roles:['recognition','super_user'],
      htmlBefore: '<i class="material-icons">record_voice_over</i>',
      htmlAfter: '',
    }]
    ...
    },
    {
      ...
      //   title: 'General',
      //   to: '/administracion',
      //   roles:['evaluation finance','finance','super_user'],
      //   htmlBefore: '<i class="material-icons">record_voice_over</i>',
      //   htmlAfter: '',
      // },
      {
